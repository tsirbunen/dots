...
//   // const updatedState = cloneDeep(state)
//   if (!state.pollInFocus) return state
//   const focusPoll = cloneDeep(state.pollInFocus) as unknown as Poll
//   console.log({ focusPoll })

//   // const focusPoll = updatedState.pollInFocus
//   if (!focusPoll || !focusPoll.options) return state
//   const updatedOptions = focusPoll.options.map((option) => {
